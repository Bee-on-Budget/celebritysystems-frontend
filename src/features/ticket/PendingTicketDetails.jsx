...
import { FiArrowLeft, FiCalendar, FiUser, FiCheckCircle, FiAlertCircle, FiTrash2, FiEdit3, FiX } from 'react-icons/fi';
              ...
              <div className="space-y-4">
                ...
                {ticket.assignedToWorkerName && (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p>{ticket.assignedToWorkerName}</p>
                  </div>
                )}
                {ticket.assignedBySupervisorName && (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p>{ticket.assignedBySupervisorName}</p>
                  </div>
                )}
              </div>
            </div>
              ...
              {ticket.openedAt && (
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">{new Date(ticket.openedAt).toLocaleString()}</p>
                  </div>
                </div>
              )}
              {ticket.inProgressAt && (
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">{new Date(ticket.inProgressAt).toLocaleString()}</p>
                  </div>
                </div>
              )}
              {ticket.resolvedAt && (
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">{new Date(ticket.resolvedAt).toLocaleString()}</p>
                  </div>
                </div>
              )}
              {ticket.closedAt && (
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">{new Date(ticket.closedAt).toLocaleString()}</p>
                  </div>
                </div>
              )}
            </div>
